var head_negative = {
	sc: ["#N算什么？", "胡说八道！","#N#B无耻！","#N#B是原则性问题,怎么能讨论呢！","我要打#N！","让我先看看新闻。","都说不发表意见了……", "我不给#N#B,你记住了。","#N是国家的走狗。","我就不信了,#N敢#B！"],
	tc: ["#N算什麼？", "胡說八道！","#N#B無恥！","#N#B是原則性問題,怎麼能討論呢！","我要打#N！","讓我先看看新聞。","都說不發表意見了……", "我不給#N#B,你記住了。","#N是國家的走狗。","我就不信了,#N敢#B！"]
}

var sentence_negative = {
	sc: ["规则不是人定的,#N#B的行为是在乱定规则。","我的政敌越来越多。","看来#N既不唯心也不唯物。","我请#N记住,真理是不能讨论的。","#N怎么能按人数#B呢？","#N就像国企一样剥削人民。","这种事是要总理第一时间赶到现场,而不是#N#B。", "你你你……","#N讲的不清不楚。","#N像毛一样死了。","#N用自己的言论和自己说#B吧！","#N怎么不说美国的#B？！","#N#B,但我只想跟随全国人民的脚步。","#N出了问题要负责的。","坐车不按人数,#N也不能#B。","这种时候#N应该写社论振奋人心，不应该#B。","原来如此,#N讲的不清不楚。"],
	tc: ["規則不是人定的,#N#B的行為是在亂定規則。","我的政敵越來越多。","看來#N既不唯心也不唯物。","我請#N記住,真理是不能討論的。","#N怎麼能按人數#B呢？","#N就像國企一樣剝削人民。","這種事是要總理第一時間趕到現場,而不是#N#B。", "你你你……","#N講的不清不楚。","#N像毛一樣死了。","#N用自己的言論和自己說#B吧！","#N怎麼不說美國的#B？！","#N#B,但我只想跟隨全國人民的腳步。","#N出了問題要負責的。","坐車不按人數,#N也不能#B。","這種時候#N應該寫社論振奮人心，不應該#B。","原來如此,#N講的不清不楚。"]
}

var head_positive = {
	sc: ["对于#N#B的行为,说不好吧,也不太好。说好吧,也不太好。所以就说好了。","让我先看看新闻。","#N现在是#B啊,我怎么能不支持。","#N#B,已经被#N政府的人民钦定了！","让我先看看新闻。","#N再不#B我就看春晚了。"],
	tc: ["對於#N#B的行為,說不好吧,也不太好。說好吧,也不太好。所以就說好了。","讓我先看看新聞。","#N現在是#B啊,我怎麼能不支持。","#N#B,已經被#N政府的人民欽定了！","讓我先看看新聞。","#N再不#B我就看春晚了。"]
}

var sentence_positive = {
	sc: ["#N不#B,大陆与台湾就无法和平统一。","#B越多#B越快越好。","#N#B说明他们没有生产资料公有制,很好。","我无话可说啊,还没处理完外交事务。", "这是#N团结一心的表现,为了保证地方行政区稳定地#B。", "总书记第一时间就做出了指示。","#B是战略。","只有#N可以#B。","这是另一种表现,因为#N为全国人民已经做出来巨大牺牲。", "没有资产阶级,也没有#N#B。","这种事是要#N第一时间#B。","我什么都没说。","#N是为了中国的外交而#B的。","快快快。","我沉默就完了。","#N不#B就要武统。"],
	tc: ["#N不#B,大陸與台灣就無法和平統一。","#B越多#B越快越好。","#N#B說明他們沒有生產資料公有製,很好。","我無話可說啊,還沒處理完外交事務。", "這是#N團結一心的表現,為了保證地方行政區穩定地#B。", "總書記第一時間就做出了指示。","#B是戰略。","只有#N可以#B。","這是另一種表現,因為#N為全國人民已經做出來巨大犧牲。", "沒有資產階級,也沒有#N#B。","這種事是要#N第一時間#B。","我什麼都沒說。","#N是為了中國的外交而#B的。","快快快。","我沉默就完了。","#N不#B就要武統。"]
}

var verb = {
	sc: ["通过", "签署", "开放", "承认", "否认", "推出", "退出", "拒绝", "谴责", "支持", "宣称", "表彰", "煽动", "组织", "公然挑衅", "成立", "模糊", "退出"],
	tc: ["通過", "簽署", "開放", "承認", "否認", "推出", "退出", "拒絕", "譴責", "支持", "宣稱", "表彰", "煽動", "組織", "公然挑釁", "成立", "模糊", "退出"]
}

var ob = {
	sc: ["贸易保护主义政策", "新法案", "互惠贸易协议", "工作签证", "全民公投", "独立公投", "网络空间主权", "罢工运动", "互联网自由运动", "言论自由共识", "全民免费医保", "高等教育学费", "在历史课本中新增章节", "删除敏感信息", "更新隐私协议", "减弱文化审查力度", "间接民主制度", "社会主义理论基础", "再次全票当选"],
	tc: ["貿易保護主義政策", "新法案", "互惠貿易協議", "工作簽證", "全民公投", "獨立公投", "網絡空間主權", "罷工運動", "互聯網自由運動", "言論自由共識", "全民免費醫保", "高等教育學費", "在歷史課本中新增章節", "刪除敏感信息", "更新隱私協議", "減弱文化審查力度", "間接民主制度", "社會主義理論基礎", "再次全票當選"]
}

var countries = {
	sc: "蔡英文、韩国瑜、宋楚瑜、习近平、邓小平、毛泽东、江泽民、希特勒、墨索里尼、马克思、恩格斯、安倍晋三、普京、川普、林郑月娥、赵紫阳、林彪".split("、"),
	tc: "蔡英文、韓國瑜、宋楚瑜、習近平、鄧小平、毛澤東、江澤民、希特勒、墨索里尼、馬克思、恩格斯、安倍晉三、普京、川普、林鄭月娥、趙紫陽、林彪".split("、")
}
