...
var sentence_negative = {
	sc: ["规则不是人定的,#N#B的行为是在乱定规则。","我的政敌越来越多。","我的政敌越来越多。","看来#N既不唯心也不唯物。","我请#N记住,真理是不能讨论的。","#N是国家的走狗。","我就不信了,#N敢#B！","#N怎么能按人数#B呢？","#N就像国企一样剥削人民。","这种事是要总理第一时间赶到现场,而不是#N#B。", "你你你……","#N讲的不清不楚。","#N像毛一样死了。","#N用自己的言论和自己说#B吧！","#N怎么不说美国的#B？！","#N#B,但我只想跟随全国人民的脚步。","#N出了问题要负责的。","坐车不按人数,#N也不能#B。","这种时候#N应该写社论振奋人心，不应该#B。","原来如此,#N讲的不清不楚。"],
	tc: ["規則不是人定的,#N#B的行為是在亂定規則。","我的政敵越來越多。","我的政敵越來越多。","看來#N既不唯心也不唯物。","我請#N記住,真理是不能討論的。","#N是國家的走狗。","我就不信了,#N敢#B！","#N怎麼能按人數#B呢？","#N就像國企一樣剝削人民。","這種事是要總理第一時間趕到現場,而不是#N#B。", "你你你……","#N講的不清不楚。","#N像毛一樣死了。","#N用自己的言論和自己說#B吧！","#N怎麼不說美國的#B？！","#N#B,但我只想跟隨全國人民的腳步。","#N出了問題要負責的。","坐車不按人數,#N也不能#B。","這種時候#N應該寫社論振奮人心，不應該#B。","原來如此,#N講的不清不楚。"]
}
