...
var sentence_negative = {
	sc: ["规则不是人定的,#N#B的行为是在乱定规则。","我的政敌越来越多。","看来#N既不唯心也不唯物。","我请#N记住,真理是不能讨论的。","#N怎么能按人数#B呢？","#N就像国企一样剥削人民。","这种事是要总理第一时间赶到现场,而不是#N#B。", "你你你……","#N讲的不清不楚。","#N用自己的言论和自己说#B吧！","#N怎么不说美国的#B？！","#N#B,但我只想跟随全国人民的脚步。","#N出了问题要负责的","坐车不按人数,#N也不能#B。","我沉默就完了。","原来如此,#N讲的不清不楚。"],
	tc: ["規則不是人定的,#N#B的行為是在亂定規則。","我的政敵越來越多。","看來#N既不唯心也不唯物。","我請#N記住,真理是不能討論的。","#N怎麼能按人數#B呢？","#N就像國企一樣剝削人民。","這種事是要總理第一時間趕到現場,而不是#N#B。", "你你你……","#N講的不清不楚。","#N用自己的言論和自己說#B吧！","#N怎麼不說美國的#B？！","#N#B,但我只想跟隨全國人民的腳步。","#N出了問題要負責的","坐車不按人數,#N也不能#B。","我沉默就完了。","原來如此,#N講的不清不楚。"]
}

var head_positive = {
	sc: ["对于#N#B的行为,说不好吧,也不太好。说好吧,也不太好。所以就说好了。","让我先看看新闻。","#N现在是#B啊,我怎么能不支持。","#N#B,已经被#N政府的人民钦定了！","让我先看看新闻。","#N再不#B我就看春晚了。","这种事是要#N第一时间#B。","我什么都没说。"],
	tc: ["對於#N#B的行為,說不好吧,也不太好。說好吧,也不太好。所以就說好了。","讓我先看看新聞。","#N現在是#B啊,我怎麼能不支持。","#N#B,已經被#N政府的人民欽定了！","讓我先看看新聞。","#N再不#B我就看春晚了。","這種事是要#N第一時間#B。","我什麼都沒說。"]
}

var sentence_positive = {
	sc: ["#N不#B,大陆与台湾就无法和平统一。","#B越多#B越快越好。","#N#B说明他们没有生产资料公有制,很好。","我无话可说啊,还没处理完外交事务。", "这是#N团结一心的表现,为了保证地方行政区稳定地#B。", "总书记第一时间就做出了指示。","#B是战略。","只有#N可以#B。","#N像毛一样死了。", "这是另一种表现,因为#N为全国人民已经做出来巨大牺牲。", "没有资产阶级,也没有#N#B。"],
	tc: ["#N不#B,大陸與台灣就無法和平統一。","#B越多#B越快越好。","#N#B說明他們沒有生產資料公有製,很好。","我無話可說啊,還沒處理完外交事務。", "這是#N團結一心的表現,為了保證地方行政區穩定地#B。", "總書記第一時間就做出了指示。","#B是戰略。","只有#N可以#B。","#N像毛一樣死了。", "這是另一種表現,因為#N為全國人民已經做出來巨大犧牲。", "沒有資產階級,也沒有#N#B。"]
}
