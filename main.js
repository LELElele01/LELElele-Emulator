...
var sentence_positive = {
	sc: ["#N不#B,大陆与台湾就无法和平统一。","#B越多#B越快越好。","#N#B说明他们没有生产资料公有制,很好。","我无话可说啊,还没处理完外交事务。", "这是#N团结一心的表现,为了保证地方行政区稳定地#B。", "总书记第一时间就做出了指示。","#B是战略。","只有#N可以#B。","这是另一种表现,因为#N为全国人民已经做出来巨大牺牲。", "没有资产阶级,也没有#N#B。","这种事是要#N第一时间#B。","我什么都没说。","#N是为了中国的外交而#B的。","快快快。","我沉默就完了。"],
	tc: ["#N不#B,大陸與台灣就無法和平統一。","#B越多#B越快越好。","#N#B說明他們沒有生產資料公有製,很好。","我無話可說啊,還沒處理完外交事務。", "這是#N團結一心的表現,為了保證地方行政區穩定地#B。", "總書記第一時間就做出了指示。","#B是戰略。","只有#N可以#B。","這是另一種表現,因為#N為全國人民已經做出來巨大犧牲。", "沒有資產階級,也沒有#N#B。","這種事是要#N第一時間#B。","我什麼都沒說。","#N是為了中國的外交而#B的。","快快快。","我沉默就完了。"]
}
