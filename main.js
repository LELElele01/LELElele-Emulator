...
var sentence_positive = {
    sc: [
        ...
        "#N#B,已经被#N政府的人民钦定了！",
        "#N再不#B我就看春晚了。",
        "这是#N团结一心的表现,为了保证地方行政区稳定地#B。",
        "总书记第一时间就做出了指示。",
        "#B是战略。",
        "只有#N可以#B。",
        "这是另一种表现,因为#N为全国人民已经做出来巨大牺牲。",
        "没有资产阶级,也没有#N#B。",
        "这种事是要#N第一时间#B。",
        "我什么都没说。",
        "#N是为了中国的外交而#B的。",
    ...
    tc: [
        ...
        "#N#B,已經被#N政府的人民欽定了！",
        "#N再不#B我就看春晚了。",
        "這是#N團結一心的表現,為了保證地方行政區穩定地#B。",
        "總書記第一時間就做出了指示。",
        "#B是戰略。",
        "只有#N可以#B。",
        "這是另一種表現,因為#N為全國人民已經做出來巨大犧牲。",
        "沒有資產階級,也沒有#N#B。",
        "這種事是要#N第一時間#B。",
        "我什麼都沒說。",
        "#N是為了中國的外交而#B的。",
